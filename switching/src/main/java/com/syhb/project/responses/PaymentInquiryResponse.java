...
public class PaymentInquiryResponse extends TransactionResponse {

    private final Logger logger = LogManager.getLogger(PaymentInquiryResponse.class);
    ...
    public String process(TransactionHelper transactionHelper) {
        ...
        try {
            ...
            logger.error("In PaymentInquiryResponse process. Message: "+ e.getMessage());
        }
