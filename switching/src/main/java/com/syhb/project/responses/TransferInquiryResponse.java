...
public class TransferInquiryResponse extends TransactionResponse {

    private final Logger logger = LogManager.getLogger(TransferInquiryResponse.class);
    ...
    public String process(TransactionHelper transactionHelper) {
        ...
        try {
            ...
            logger.error("In TransferInquiryResponse process. Message: "+ e.getMessage());
        }
