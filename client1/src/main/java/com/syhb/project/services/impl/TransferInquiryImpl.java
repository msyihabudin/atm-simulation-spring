...
public class TransferInquiryImpl implements Transaction {

    private final Logger logger = LoggerFactory.getLogger(TransferInquiryImpl.class);

    @Override
    public String send(TransactionHelper transactionHelper) {

        logger.info("In TransferInquiryImpl send");
        ...
        try {
            ...
            logger.debug("In TransferInquiryImpl send. Message: "+ e.getMessage());
        }
