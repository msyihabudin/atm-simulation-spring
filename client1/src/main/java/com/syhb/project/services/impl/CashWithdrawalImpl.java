...
public class CashWithdrawalImpl implements Transaction {

    private final Logger logger = LoggerFactory.getLogger(CashWithdrawalImpl.class);

    @Override
    public String send(TransactionHelper transactionHelper) {

        logger.info("In CashWithdrawalImpl send");
        ...
        try {
            ...
            logger.debug("In CashWithdrawalImpl send. Message: "+ e.getMessage());
        }
